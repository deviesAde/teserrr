                                    ...
                                    <tr class="hover:bg-gray-50 transition-colors duration-200">
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                            <div class="flex items-center space-x-3">
                                                ...
                                                <a href="{{ route('petani.laporan.edit', $laporan) }}"
                                                ...
                                                <form action="{{ route('petani.laporan.destroy', $laporan) }}"
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            if (searchForm && searchInput && resetButton && mitraList) {
                ...
                function performSearch() {
                    ...
                    // Make AJAX request
                    fetch(`{{ route('petani.laporan.search-mitra-index') }}?search=${encodeURIComponent(searchValue)}`)
