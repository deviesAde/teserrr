        ...
        <div class="max-w-5xl mx-auto">
            ...
            <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4 mb-8">
                ...
                <div id="statusButton"
                    ...
                    @else bg-yellow-100 text-yellow-800 @endif shadow transition">
                    <span>Status: {{ ucfirst($mitra->status) }}</span>
                    ...
                    <div class="space-y-3">
                        ...
                        <div>
                            ...
                            <div class="mt-1 flex items-center space-x-2">
                                <p id="phoneNumber">{{ $mitra->telepon }}</p>
                                <button id="copyBtn" onclick="copyPhoneNumber()" class="text-blue-600 hover:text-blue-800 transition-colors duration-200" title="Salin nomor telepon">
                                    <!-- Icon copy -->
                                    ...
                                    <svg id="iconCheck" xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 hidden" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    <div class="space-y-3">
                        ...
                        <div>
                            ...
                            <div class="flex items-center justify-between">
                                ...
                                <button type="button"
                                    ...
                                    data-jumlah="{{ $mitra->jumlah_pohon }}">
                        ...
                        <div>
                            ...
                            <p class="mt-1">
                                ...
                                {{ $mitra->provinsi->nama ?? $mitra->provinsi ?? '-' }}
                            </p>
                        </div>
                    </div>
                </div>
